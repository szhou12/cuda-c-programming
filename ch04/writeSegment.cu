...
{
    std::cout << "writeSegment program starts ..." << std::endl;
    ...
    CHECK(cudaDeviceSynchronize());
    std::cout << "writeOffset: " << GetDurationInMicroSeconds(begin, StopTimer()) << " microsecs" << std::endl;
    CHECK(cudaGetLastError());
    ...
    CHECK(cudaDeviceSynchronize());
    std::cout << "writeOffsetUnroll2: " << GetDurationInMicroSeconds(begin, StopTimer()) << " microsecs" << std::endl;    
    CHECK(cudaGetLastError());
    ...
    CHECK(cudaDeviceSynchronize());
    std::cout << "writeOffsetUnroll4: " << GetDurationInMicroSeconds(begin, StopTimer()) << " microsecs" << std::endl;
    CHECK(cudaGetLastError());
