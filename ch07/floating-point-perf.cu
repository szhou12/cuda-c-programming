    ...
    float* sample, int sampleLength)
{
    ...
    *toDeviceTime = GetDurationInMicroSeconds(begin, StopTimer());
    ...
    *kernelTime = GetDurationInMicroSeconds(begin, StopTimer());
    ...
    *fromDeviceTime = GetDurationInMicroSeconds(begin, StopTimer());
