...
{
    std::cout << "transposeRectangle program starts ..." << std::endl;
    ...
    std::cout << "copyGmem: " << GetDurationInNanoSeconds(begin, StopTimer()) << " nanosecs" << std::endl;
    ...
    CHECK(cudaDeviceSynchronize());
    std::cout << "naiveGmem: " << GetDurationInNanoSeconds(begin, StopTimer()) << " nanosecs" << std::endl;
    ...
    CHECK(cudaDeviceSynchronize());
    std::cout << "naiveGmemUnroll: " << GetDurationInNanoSeconds(begin, StopTimer()) << " nanosecs" << std::endl;
    CHECK(cudaMemcpy(gpuRef, d_C, nBytes, cudaMemcpyDeviceToHost));
    if (iprint) 
        printData(gpuRef, nx * ny);
    ...
    std::cout << "transposeSmem: " << GetDurationInNanoSeconds(begin, StopTimer()) << " nanosecs" << std::endl;
    ...
    std::cout << "transposeSmemPad: " << GetDurationInNanoSeconds(begin, StopTimer()) << " nanosecs" << std::endl;
    ...
    begin = StartTimer();
    transposeSmemDyn << <grid, block, BDIMX* BDIMY * sizeof(float) >> > (d_C, d_A, nx, ny);
    std::cout << "transposeSmemDyn: " << GetDurationInNanoSeconds(begin, StopTimer()) << " nanosecs" << std::endl;
    ...
    std::cout << "transposeSmemUnroll: " << GetDurationInNanoSeconds(begin, StopTimer()) << " nanosecs" << std::endl;
    ...
    std::cout << "transposeSmemUnrollPad: " << GetDurationInNanoSeconds(begin, StopTimer()) << " nanosecs" << std::endl;
    ...
    std::cout << "transposeSmemUnrollPadDyn: " << GetDurationInNanoSeconds(begin, StopTimer()) << " nanosecs" << std::endl;
